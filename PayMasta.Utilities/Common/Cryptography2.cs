...
namespace PayMasta.Utilities.Common
{
    public class Cryptography2
    {
        ...
        public Cryptography2(string key)
        {
            ...
            myRijndael.IV = iv;//HexStringToByteArray(key);

            myRijndael.Padding = PaddingMode.PKCS7;
            myRijndael.Mode = CipherMode.CBC;
            iterations = 1000;
            salt = System.Text.Encoding.UTF8.GetBytes(key);
            myRijndael.Key = keybytes; //GenerateKey(strPassword);
        }
